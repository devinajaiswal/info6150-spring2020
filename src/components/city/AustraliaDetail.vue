...
<h2>Seek out some sunshine and good times in Australia's Harbour City.</h2>
...
<img class="cmp-image "  src="https://www.australia.com/content/australia/en_us/places/sydney-and-surrounds/guide-to-sydney/_jcr_content/mainParsys/imagewithcaption/LargeImageTile/largeImageSrc.adapt.740.medium.jpg">
</div></el-col>
</el-row>
<el-row type="flex" class="row-bg" justify="center">
...
<li>Decide when to visit and what to pack with this info on seasonal weather in Sydney.</li>
<li>Find all of the city’s transport options with this guide on getting around.</li>
<li>Visit a local visitor information centre for more detailed info on the area.</li>
</ul>
</div></el-col>
</el-row>
</div>
