...
<h2>Poets, artists, playwrights, writers, journalists, and more have all written about their love of this city.</h2>
...
<img class="cmp-image "  src="https://images.unsplash.com/photo-1544144610-fe28b99434d7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80">
</div></el-col>
</el-row>
<el-row type="flex" class="row-bg" justify="center">
...
<li>The best time to visit is May, early June, September, or October, when there are fewer crowds and the weather is still sunny and warm. </li>
<li> Summer is the most popular (and most expensive) season to visit, when the weather is warm and dry.</li>
<li>Winter can be dark and chilly, but while the weather may not be perfect, Paris is particularly beautiful in the winter.</li>
</ul>
</div></el-col>
</el-row>
